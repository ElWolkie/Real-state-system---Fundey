    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-box-open"></i> &nbsp;<span style="font-size: 25px; font-family: Verdana, Geneva, Tahoma, sans-serif;">RECURSO MATERIAL</span>
                </h3>
            </div>
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a href="recurso-mater.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR RECURSOS</a>
                    </li>
                    <li>
                        <a href="recurso-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA RECURSOS</a>
                    </li>
                    <li>
                        <a href="recurso-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR RECURSOS</a>
                    </li>
                </ul>
            </div>
